...
if (isset($_POST['submit'])) {
    ...
    $stmt=$dbcon->prepare('insert into ui_ux_designer (sname,semail,sphone,smessage) values(:sname,:semail,:sphone,:smessage)');
    ...
    if($eq) {
        ...
        location.href='ui_ux_designer_courses.php';
        </script>";
    } else {
